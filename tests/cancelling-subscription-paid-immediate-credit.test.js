...
// Test that free subscriptions can be cancelled with credit
// 
...
//    cancels creating credit for the unused balance

describe(`tests/cancelling-subscription-paid-immediate-credit`, () => {
  it('should credit subscription and uninstall', async () => {
    global.pageSize = 40
    // owner
