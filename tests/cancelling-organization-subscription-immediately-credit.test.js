...
// immediately with credit for the unused balance
// 
...
// 6) the app is uninstalled and a credit is created

describe(`tests/cancelling-organization-subscription-credit`, () => {
  it('should credit organization subscription and uninstall for all users', async () => {
    global.pageSize = 40
    // owner
    ...
    await TestHelper.completeForm(customer1Tab, {})
    // customer 1 has uninstalled the app and received credit
    await TestHelper.clickPageLink(customer1Tab, 'Home')
    await customer1Tab.waitFor(1000)
