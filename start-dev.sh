...
APPID=$APP_STORE_DOMAIN \
APPLICATION_SERVER="http://localhost:7001" \
APPLICATION_SERVER_TOKEN="$APP_STORE_APPLICATION_SERVER_TOKEN" \
BCRYPT_FIXED_SALT="$APP_STORE_BCRYPT_FIXED_SALT" \
BCRYPT_WORKLOAD_FACTOR=$APP_STORE_BCRYPT_WORKLOAD_FACTOR \
DASHBOARD_SERVER="$APP_STORE_DASHBOARD_SERVER" \
DASHBOARD_SESSION_KEY="$APP_STORE_DASHBOARD_SESSION_KEY" \
